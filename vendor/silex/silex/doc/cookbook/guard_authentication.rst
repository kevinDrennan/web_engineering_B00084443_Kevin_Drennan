...
header on each request. This token is composed of the collegeId followed
...
.. code-block:: php
    ...
    class TokenAuthenticator extends AbstractGuardAuthenticator
    {
        ...
        public function getCredentials(Request $request)
        {
            ...
            list($collegeId, $secret) = explode(':', $token, 2);
        ...
        {
            return $userProvider->loadUserByUsername($credentials['collegeId']);
        }
